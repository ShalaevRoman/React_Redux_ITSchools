...
//     registerCourse(courseName, totalLessons, availableTeachersAmount) -- метод должен создавать новый объект класса CourseList eсли такого курса еще нет среди доступных курсов в школе.
...
// ---------------------------
//     Класс CourseList должен содержать в себе только конструктор, который принимает имя курса, количество уроков на курсе (на нашем с вами курсе например 38 уроков) и доступное количество преподавателей на этом курсе. Это количество будет уменьшаться каждый раз когда в школе стартует новая группа по этому курсу.
// ---------------------------
